...
const Events = () => {
  return (
    <div className="flex flex-col gap-28 w-full lg:px-16 px-4 py-40">
      <div className="flex flex-col items-center gap-[65px]">
        <div className="flex flex-col gap-4 items-end w-full">
          <div className="relative w-full">
            <img
              src={LeftArrow}
              alt="left arrow"
              className="absolute sm:-right-10 -right-5 sm:-top-10 -top-5 rotate-180 w-[40px] sm:w-auto"
            />
            ...
            <div className="relative group w-full ">
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-50 px-4 sm:px-5 py-3 flex flex-col items-center justify-center gap-3 rounded-[12px] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <h1 className="text-white text-[26px] sm:text-[32px] md:text-[40px]  font-bold font-geist">
                  Bootcamp 101
                </h1>
                <p className="text-white font-geist text-[18px] sm:text-[22px] md:text-[26px] overflow-auto text-center">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Officiis repellendus corrupti temporibus blanditiis adipisci
                  earum ut consequuntur debitis ullam ipsa assumenda veritatis
                  perspiciatis, totam voluptatem suscipit deserunt incidunt
                  ratione laudantium.
                </p>
              </div>
            </div>
            <img
              src={LeftArrow}
              alt="left arrow"
              className="absolute sm:-left-10 -left-5 sm:-bottom-10 -bottom-5 sm:w-auto w-[40px]"
            />
          </div>
        ...
        <div className="flex flex-col items-center gap-3">
          <span className=" text-[24px] sm:text-[28px] font-geist font-semibold text-center text-light_purple leading-[35px]">
            {" "}
            know more about <br /> the event
          </span>
          <img src={DownArrow} alt="down-arrow" className="w-[100px] sm:w-auto"/>
        </div>
      </div>
      <div className="flex flex-col items-center gap-14 w-full">
        <h1 className="font-geist sm:text-[48px] text-[36px]  font-bold text-white">
          Speakers :
        </h1>
        <div className="flex items-center gap-7 w-full justify-center lg:flex-nowrap flex-wrap ">
        ...
        <div className="flex items-center gap-[60px] flex-wrap">
          {bootcampStat.map((stat, index) => {
            return (
              <div
                key={index}
                className="sm:w-[300px] lg:flex-grow-0 flex-grow flex flex-col items-center gap-2 bg-gradient-to-b from-[#87028390] to-[#21002040] px-[26px] py-[41px] rounded-[10px]"
              >
                <span className="text-white sm:text-[48px] text-[36px]  font-geist font-bold leading-[62px]">
                  +{stat.count}
                </span>
                <span className="text-white sm:text-[36px] text-[28px] font-medium font-geist leading-[46px]">
                  {stat.title}
                </span>
              </div>
            );
      ...
      <div className="flex flex-col items-center gap-14 w-full">
        <div className="flex flex-col items-center gap-10">
          ...
          >
            <button className="py-2 sm:px-14 px-8 rounded-[10px] border-[2px] border-white font-geist text-[26px] sm:text-[30px] leading-[41px] text-white border-opacity-40">
              Check Website
            </button>
          </a>
        </div>
